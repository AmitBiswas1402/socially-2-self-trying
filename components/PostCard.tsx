...
const PostCard = ({
  ...
  const handleConfirmDeleteComment = async () => {
    ...
    try {
      ...
      const result = await deleteComment(commentToDelete, post.id);
  ...
  return (
    <div onClick={handleCardClick} className="block cursor-pointer">
      <Card className="bg-transparent border shadow-none rounded-none hover:bg-zinc-900/50 transition-colors">
        <CardContent className="p-0">
          <div className="px-4 pt-3 pb-2">
            <div className="flex space-x-3 sm:space-x-4">
              <div onClick={handleProfileClick}>
                <Avatar className="size-8 sm:w-10 sm:h-10 cursor-pointer hover:opacity-80">
